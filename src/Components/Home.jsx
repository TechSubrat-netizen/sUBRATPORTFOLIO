...
import pdf from '../assets/SubratCV.pdf'
  ...
  A Passionate <span className="text-teal-400">React Native Developer</span> crafting cross-platform mobile applications with intuitive user experiences.
      ...
      <section id="about" className="py-20 px-6 bg-gray-800">
        ...
        <p className="max-w-3xl mx-auto text-lg text-gray-300 text-center">
         I am a skilled software developer currently working as a React Native Developer, with expertise in the MERN stack. I specialize in building cross-platform mobile apps and full-stack web applications that are scalable, responsive, and user-friendly. My passion lies in both frontend design and backend development, using technologies like React, React Native, Node.js, Express, and MongoDB. I enjoy crafting intuitive user experiences and continuously explore new tools and best practices to enhance my skills and deliver high-quality digital solutions.
        </p>
      </section>
      ...
      <section id="skills" className="py-20 px-6">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {["React.js","React Native", "Node.js", "Express", "MongoDB", "JavaScript", "HTML5", "CSS3", "Git","DSA","Bootstrap","Tailwind","Python","Netify","Git"  ,"Github","Oracle Sql"].map((skill, idx) => (
            <div
              key={idx}
