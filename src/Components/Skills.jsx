...
function Skills() {
  const skillCategories = [
...

    {
      title: "Networking",
      skills: [
        { name: "Network Troubleshooting", icon: <FaNetworkWired />, color: "text-blue-400" },
        { name: "Router Configuration", icon: <FaServer />, color: "text-green-400" },
        { name: "Switch Configuration", icon: <FaServer />, color: "text-purple-400" },
        { name: "LAN/WAN", icon: <FaWifi />, color: "text-cyan-400" },
        { name: "IP Addressing", icon: <FaNetworkWired />, color: "text-orange-400" },
        { name: "Technical Support", icon: <FaServer />, color: "text-red-400" },
      ],
    },

    {
      ...
      skills: [
        ...
        { name: "SQL", icon: <SiMysql />, color: "text-gray-400" },
      ],
    },
    ...
    <section id="skills" className="min-h-screen py-20 bg-gray-900 text-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-gray-300 text-center mb-10">
          A showcase of my technical skills in networking, application
          development, and modern technologies.
        </p>

        {skillCategories.map((category, index) => (
          <div key={index} className="mb-12">
            <h3 className="text-2xl font-semibold mb-6 text-center text-purple-400 underline">
              {category.title}
            </h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
              {category.skills.map((skill, i) => (
                <div
                  ...
                  hover:border-cyan-400 hover:shadow-cyan-500/50 hover:shadow-md
